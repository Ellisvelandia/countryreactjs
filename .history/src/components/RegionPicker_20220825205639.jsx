        ...
        <Container fixed>
          ...
          >
            <Grid container spacing={1} columnbs={12}>
              ...
              <Grid item xs={12} md={6} lg={6}>
                <div className="region-container" onClick={() => onRegionPickerHandler('americas')}>
              ...
              <Grid item xs={12} md={6} lg={6}>
                <div className="region-container" onClick={() => onRegionPickerHandler('europe')}>
              ...
              <Grid item xs={12} md={6} lg={6}>
                <div className="region-container" onClick={() => onRegionPickerHandler('asia')}>
